...
<section class="container">
  ...
  <h2 class="my-4">About The Product</h2>
    ...
    <div class="form-group row">
      <label for="q1" class="col-sm-6 col-form-label">Q1: Name of the product: (Include the name brand last) 1. What is the name of the product your
    ...
    <div class="form-group row mb-4">
      <label for="q2" class="col-sm-6 col-form-label">Q2: Type of product: What exactly are you selling.<br> (ex: Wooden Spoons - Flight Pillow - Phone
        Cover)</label>
      <div class="col-sm-6">
    ...
    <div class="form-group row">
      <label for="q3" class="col-sm-6 col-form-label">Q3: Target Audience for this product: (Singular Word)<br> (ex: A Chef - Executive - Iphone Owner)</label>
      <div class="col-sm-6">
    ...
    <div class="form-group row">
      <label for="q5" class="col-sm-6 col-form-label">Q5: In 2 to 3 words: What are the main area of focus for this product (ex: Cook faster - Helps you relax - Save from smashing)</label>
      <div class="col-sm-6">
    ...
    <div class="form-group row">
      <label for="q10" class="col-sm-6 col-form-label">Q10: Why is this hurdle such a big dael for your target audience:<br>"This hurdle is such a huge deal because ........" <small>(ex: Without the right spoon, cooking will fail miserably - If you don't rest well travelling
    ...
    <div class="form-group row">
      <label for="q12" class="col-sm-6 col-form-label">Q12: What's an idea your target audience believe is true but is actually completely wrong?<br><small>(ex: All cooking spoons are practically the same, so you can just buy the cheapest one - A travelling pillow will not
    ...
    <hr> 
    <h2 class="my-4">Features and Benefits</h2>
      <!-- one -->
      <div class="form-group row">
    ...
    <div class="form-group row">
      <label for="q16" class="col-sm-6 col-form-label">Q16: What is the benefit (what it does OR means) of the #2 feature above?<br> "With the #2 feature you can ........ (start with a Verb)"<small> (ex: Won’t harbor bacteria in hidden crevices - Can better fix your neck
    ...
    <div class="form-group row">
      <label for="q18" class="col-sm-6 col-form-label">Q18: What is the benefit (what it does OR means) of the #3 feature above?<br> "With the #3 feature you can ........ (start with a Verb)"<small> (ex: Won’t scratch any parts of your kitchen - you can adjust the angle
            ...
            <?php
              if (isset($_POST['listing-submit'])) {
                ...
                if(!empty($_REQUEST['q1'])) {
                  $q1 = $_REQUEST['q1'];    
                  echo '<a href="#q1" class="list-group-item list-group-item-action list-group-item-primary"> Q1: '.$q1.'</a>';
                ...
                if(!empty($_REQUEST['q2'])) {
                  $q2 = $_REQUEST['q2'];    
                  echo '<a href="#q2" class="list-group-item list-group-item-action list-group-item-primary">Q2: '.$q2.'</a>';
                ...
                if(!empty($_REQUEST['q3'])) {
                  $q3 = $_REQUEST['q3'];    
                  echo '<a href="#q3" class="list-group-item list-group-item-action list-group-item-primary">Q3: '.$q3.'</a>';
                ...
                if(!empty($_REQUEST['q4'])) {
                  $q4 = $_REQUEST['q4'];    
                  echo '<a href="#q4" class="list-group-item list-group-item-action list-group-item-primary">Q4: '.$q3.'</a>';
                ...
                if(!empty($_REQUEST['q5'])) {
                  $q5 = $_REQUEST['q5'];    
                  echo '<a href="#q5" class="list-group-item list-group-item-action list-group-item-primary">Q5: '.$q5.'</a>';
                ...
                if(!empty($_REQUEST['q6'])) {
                  $q6 = $_REQUEST['q6'];    
                  echo '<a href="#q6" class="list-group-item list-group-item-action list-group-item-primary">Q6: '.$q6.'</a>';
                ...
                if(!empty($_REQUEST['q7'])) {
                  $q7 = $_REQUEST['q7'];    
                  echo '<a href="#q7" class="list-group-item list-group-item-action list-group-item-primary">Q7: '.$q7.'</a>';
                ...
                if(!empty($_REQUEST['q8'])) {
                  $q8 = $_REQUEST['q8'];    
                  echo '<a href="#q8" class="list-group-item list-group-item-action list-group-item-primary">Q8: '.$q8.'</a>';
                ...
                if(!empty($_REQUEST['q9'])) {
                  $q9 = $_REQUEST['q9'];    
                  echo '<a href="#q9" class="list-group-item list-group-item-action list-group-item-primary">Q9: '.$q9.'</a>';
                ...
                if(!empty($_REQUEST['q10'])) {
                  $q10 = $_REQUEST['q10'];    
                  echo '<a href="#q10" class="list-group-item list-group-item-action list-group-item-primary">Q10: '.$q10.'</a>';
            ...
            <?php
              if (isset($_POST['listing-submit'])) {
                ...
                if(!empty($_REQUEST['q11'])) {
                  $q11 = $_REQUEST['q11'];    
                  echo '<a href="#q11" class="list-group-item list-group-item-action list-group-item-primary"> Q11: '.$q11.'</a>';
                ...
                if(!empty($_REQUEST['q12'])) {
                  $q12 = $_REQUEST['q12'];    
                  echo '<a href="#q12" class="list-group-item list-group-item-action list-group-item-primary">Q12: '.$q12.'</a>';
                ...
                if(!empty($_REQUEST['q13'])) {
                  $q13 = $_REQUEST['q13'];    
                  echo '<a href="#q13" class="list-group-item list-group-item-action list-group-item-primary">Q13: '.$q13.'</a>';
                ...
                if(!empty($_REQUEST['q14'])) {
                  $q14 = $_REQUEST['q14'];    
                  echo '<a href="#q14" class="list-group-item list-group-item-action list-group-item-primary">Q14: '.$q14.'</a>';
                ...
                if(!empty($_REQUEST['q15'])) {
                  $q15 = $_REQUEST['q15'];    
                  echo '<a href="#q15" class="list-group-item list-group-item-action list-group-item-primary">Q15: '.$q15.'</a>';
                ...
                if(!empty($_REQUEST['q16'])) {
                  $q16 = $_REQUEST['q16'];    
                  echo '<a href="#q16" class="list-group-item list-group-item-action list-group-item-primary">Q16: '.$q16.'</a>';
                ...
                if(!empty($_REQUEST['q17'])) {
                  $q17 = $_REQUEST['q17'];    
                  echo '<a href="#q17" class="list-group-item list-group-item-action list-group-item-primary">Q17: '.$q17.'</a>';
                ...
                if(!empty($_REQUEST['q18'])) {
                  $q18 = $_REQUEST['q18'];    
                  echo '<a href="#q18" class="list-group-item list-group-item-action list-group-item-primary">Q18: '.$q18.'</a>';
                ...
                if(!empty($_REQUEST['q19'])) {
                  $q19 = $_REQUEST['q19'];    
                  echo '<a href="#q19" class="list-group-item list-group-item-action list-group-item-primary">Q19: '.$q19.'</a>';
                ...
                if(!empty($_REQUEST['q20'])) {
                  $q20 = $_REQUEST['q20'];    
                  echo '<a href="#q20" class="list-group-item list-group-item-action list-group-item-primary">Q20: '.$q20.'</a>';
